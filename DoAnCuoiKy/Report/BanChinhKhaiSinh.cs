...
{
    public partial class BanChinhKhaiSinh : Form
    {
        public BanChinhKhaiSinh(string so)
        {
            InitializeComponent();
            ...
            rptKhaiSinhBC report = new rptKhaiSinhBC();
            report.SetDataSource(khaiSinh);

            rptViewBCKhaiSinh.ReportSource = report;
        }
    }
}
